...
class Stage2_Dataset(Dataset):
    def __init__(self, args, base_dir, split):
        ...
        if self.split   == "train":
            # self._image_dir     = os.path.join(self._base_dir, 'train_weak/')
            ...
            # self._cat_dir = os.path.join(self._base_dir, 'train_PM/SegmentationClass2/')
            # self._cat_dir_a = os.path.join(self._base_dir, 'train_PM/SegmentationClass2')
            # self._cat_dir_b = os.path.join(self._base_dir, 'train_PM/SegmentationClass2')
        elif self.split == 'val':
            ...
            # self._image_dir = os.path.join(self._base_dir, 'train_PM/SegmentationClass2')
            # self._cat_dir = os.path.join(self._base_dir, 'train_PM/SegmentationClass2')
